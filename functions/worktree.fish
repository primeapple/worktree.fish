...
function _worktree_create --argument-names target_branch
    ...
    set path_to_create "../$(__worktree_get_repo_name (pwd))+$(string replace --all "/" "~" $target_branch)"
...
function _worktree_help
    ...
    echo "  clean          Remove all non-dirty worktrees except main, review and work"
    echo "  create         Create a new worktree"
    echo "  help           Show this help message"
    echo "  init           Initialize worktree structure"
    echo "  park           Resets to default branch on the special worktrees and updates them"
    echo "  reset          Resets worktree structure"
